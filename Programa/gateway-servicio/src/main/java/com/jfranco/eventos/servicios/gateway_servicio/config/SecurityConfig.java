...
public class SecurityConfig {
    ...
    SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http){
        http.authorizeExchange(auth -> auth
            ...
            .pathMatchers("/api/asistentes/listarEventoId/{id}").hasAnyRole("ADMIN","USER")
            .pathMatchers("/api/asistentes/eliminar/{id}").hasAnyRole("ADMIN","USER")
            .pathMatchers("/api/eventos/listar").hasAnyRole("ADMIN","USER")
            .pathMatchers("/api/asistentes/**").hasRole("ADMIN")
            .pathMatchers("/api/eventos/**").hasAnyRole("ADMIN")
